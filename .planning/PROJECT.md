...
---
*Last updated: 2026-05-24 after Phase 3 re-verification — all 3 code carry-overs closed (init_guess minao/atom/huckel, mulliken_meta, int3c2e_sph/DF-HF); SCF-05 → [x], SCF-09 → [~]. Phase 3 complete (15/15); 6 CI/Python-toolchain human-verify items remain tracked in 03-HUMAN-UAT.md. Next: Phase 4 (dft).*
