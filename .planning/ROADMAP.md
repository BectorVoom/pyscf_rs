...
- [ ] **Phase 19: Periodic response + relativistic** — CPHF (reusing the single Krylov solver, GRAD-10), `newton_ah`, `stability`, `tdscf` (k + gamma, HF and KS), `gw` (AC, CD, slow), `adc` (IP/EA), `x2c` (sfx2c1e, x2c1e), `eph`. **Gate:** KRHF-TDA lowest excitation matches upstream to 1e-15 eV.
