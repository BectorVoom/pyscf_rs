...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/chemtech/workspace/pyscf_rs/.claude
                  → checks /home/chemtech/workspace/pyscf_rs/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/chemtech/workspace/pyscf_rs/.claude/get-shit-done
                  → writes to /home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/hooks/
...
@/home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
