...
<reference>
@/home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/references/user-profiling.md` to load:
