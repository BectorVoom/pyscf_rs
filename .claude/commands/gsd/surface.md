...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Documents/workspace/pyscf_rs/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/user/Documents/workspace/pyscf_rs/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/user/Documents/workspace/pyscf_rs/.claude/commands/gsd
AGENTS_DIR=/home/user/Documents/workspace/pyscf_rs/.claude/agents
```
...
<execution_context>
Surface state file: `/home/user/Documents/workspace/pyscf_rs/.claude/skills/.gsd-surface.json`
Install profile marker: `/home/user/Documents/workspace/pyscf_rs/.claude/skills/.gsd-profile`
Engine module: `/home/user/Documents/workspace/pyscf_rs/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Documents/workspace/pyscf_rs/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
