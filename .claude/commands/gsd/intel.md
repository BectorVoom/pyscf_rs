...
Intel system is disabled. To activate:
  ...
  node /home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/chemtech/workspace/pyscf_rs/.claude/get-shit-done/bin/gsd-tools.cjs
