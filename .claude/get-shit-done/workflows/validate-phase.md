...
```
Agent(
  prompt="Read /home/user/Documents/workspace/pyscf_rs/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Documents/workspace/pyscf_rs/.claude/get-shit-done/templates/VALIDATION.md`
